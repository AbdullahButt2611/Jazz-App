...
public class CallForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        calls = new javax.swing.JTextField();
        invalidCalls = new javax.swing.JLabel();
        ...
        jLabel8.setText("No of Calls :");

        calls.setBackground(new java.awt.Color(0, 0, 0));
        calls.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        calls.setForeground(new java.awt.Color(255, 255, 255));
        calls.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 0, 0), 2));

        invalidCalls.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        invalidCalls.setForeground(new java.awt.Color(204, 204, 204));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(calls, javax.swing.GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE)
                            .addComponent(jLabel8)
                            .addComponent(invalidCalls, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(167, 167, 167)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(calls, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(invalidCalls, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void usebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_usebuttonActionPerformed
        // TODO add your handling code here:
        String count = calls.getText();
            if(count.equals("") || count.equals(null))
            {
                invalidCalls.setText("Box is Empty");
            }
            else
            {
                boolean flag=false;
                ...
                if(!flag)
                    invalidCalls.setText("The Count should be in Digits");
                else
                {
                    int msg=Integer.parseInt(count);
                    int msgBalance=msg*5;
                    if(msg>=0 && msg<=50)
                    {
                        if(JazzWorld.worldInstance().getMin().get(index).GetNumberOfMinutes()>=msg)
                        {
                        ...
                        invalidCalls.setText("It should be between 0  to 50");
                }
            }
    ...
    private javax.swing.JTextField calls;
    private javax.swing.JButton cancelButton;
    private javax.swing.JLabel invalidCalls;
